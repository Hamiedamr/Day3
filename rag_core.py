...
def setup_qdrant_collection(chunks, collection_name="agentic_rag_collection"):
...
def hybrid_search_rrf(query_text, collection_name="agentic_rag_collection", limit=5, client=None, dense_embedder=None, sparse_embedder=None):
    client = client or QdrantClient(url=QDRANT_URL, check_compatibility=False)
